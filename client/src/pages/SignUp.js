...
function SignUp() {
    ...
    function handlePwTwoChange(event) {
    ...
    return (
        <Modal isOpen={modalIsOpen} style={modalStyles} >
            <div className='signUp'>
                ...
                <form className='signUp__input' required >
                ...
                <div className='signUp__footer'>
                    Already a member? <Link to='/sign-in' className='link'>Sign In</Link>
                </div>
            </div>
        </Modal>
    )
